...
from .ai_assistant_protocol import make_card, merge_cards, select_ui_cards
from .ai_config import resolve_web_search_config
...
async def run_media_search(args: dict[str, Any]) -> dict[str, Any]:
    ...
    limit = _limit(args.get("limit"), 6)
    try:
        from .media_routes import media_search
...
async def run_media_person_works(args: dict[str, Any]) -> dict[str, Any]:
    ...
    limit = _limit(args.get("limit"), 8)
    try:
        from .media_routes import media_person_works
...
def collect_ui_cards(
    ...
    *,
    ...
    from .ai_assistant_protocol import user_wants_resource_cards
