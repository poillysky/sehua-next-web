...
Smoke (manual)::
    ...
    from app.search.pack_bleed import format_size_gb, is_pack_bleed_item, links_for_resource_hash
    from app.search.resource_format import format_resource
...
from app.search.av import normalize_maker_code, parse_maker_code
...
def own_maker_codes_for_index_row(
    *,
    ...
    """
    from app.search.av import extract_maker_codes
