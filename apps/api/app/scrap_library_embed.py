...
def upsert_catalog_skeletons(
    *,
    ...
    from .prefix_catalog_strm_sync import safe_name
...
def list_facets(
    *,
    ...
    if key == "actress":
        try:
            from .scrap_library_actress_avatar import apply_actress_avatars
...
def optimize_actress_metadata(
    *,
    ...
    from .ai_embed import encode_texts_sync
    from .scrap_library_nfo import content_sha, parse_nfo
