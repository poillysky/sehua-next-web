...
def put_ai_assistant(
    ...
    from app.ai.config import _normalize_assistant_tools
...
def put_ai_embed(
    ...
    try:
        from app.ai.embed import reset_local_embed_model
...
async def test_ai_embed(
    ...
    try:
        from app.ai.embed import test_embed_connection
...
def download_ai_embed(
    ...
    try:
        from app.ai.embed import ensure_local_model_files
